...
public class SweetAlertDialog extends Dialog implements View.OnClickListener {
    ...
    public static final boolean DARK_STYLE = false;
...
//                    mButtonsContainer.setVisibility(View.GONE);
    ...
    public void setCancelButtonBackgroundColor(Integer color) {
    ...
    public void setNeutralButtonTextColor(Integer color) {
    ...
    public void setNeutralClickListener(OnSweetClickListener listener) {
    ...
    public void setNeutralButton(String text, OnSweetClickListener listener) {
